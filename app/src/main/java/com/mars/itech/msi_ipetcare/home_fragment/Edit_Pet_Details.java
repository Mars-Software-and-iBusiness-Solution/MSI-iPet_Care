...
public class Edit_Pet_Details extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        navigationView.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item)
            {
                ...
                {
                    Intent editpro = new Intent(Edit_Pet_Details.this, Edit_Owner_Details.class);
                ...
                else if(id == R.id.trackmyprogress)
                {
                    ...
                    Intent trackpro = new Intent(Edit_Pet_Details.this, My_Pet_Doc.class );
                ...
                else if(id == R.id.basic_workouts)
                {
                    ...
                    Intent basicwork = new Intent(Edit_Pet_Details.this, Track_My_Pet.class);
                ...
                else if(id == R.id.findmeaworkout)
                {
                    ...
                    Intent findtrain = new Intent(Edit_Pet_Details.this, Pet_Diet_Plan.class);
                ...
                else if(id == R.id.consultacoach)
                {
                    ...
                    Intent mytrain = new Intent(Edit_Pet_Details.this, Edit_Pet_Details.class);
                    startActivity(mytrain);
                    finish();
                }else if(id == R.id.search_user)
                {

                    Intent shareex = new Intent(Edit_Pet_Details.this, com.mars.itech.msi_ipetcare.home_fragment.Share_Experience.class);
                ...
                else if(id == R.id.settings)
                {
                    ...
                    Intent settings = new Intent(Edit_Pet_Details.this, com.mars.itech.msi_ipetcare.home_fragment.Settings.class);
                ...
                else if(id == R.id.logout)
                {
                    ...
                    Toast.makeText(Edit_Pet_Details.this, "You Have been Sign-out successfully!", Toast.LENGTH_SHORT).show();
                    finish();
                    FirebaseAuth.getInstance().signOut();
                    Intent loginIntent = new Intent(Edit_Pet_Details.this, MainActivity.class );
    ...
    public void onBackPressed() {
        ...
        Intent registerIntent = new Intent(Edit_Pet_Details.this, Home_iFit.class);
